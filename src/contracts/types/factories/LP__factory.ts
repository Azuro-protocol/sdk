...
const _abi = [
  ...
  },
  {
    inputs: [
      {
        internalType: "uint128",
        name: "reinforcementAmount",
        type: "uint128",
      },
    ],
    name: "getPossibilityOfReinforcement",
    outputs: [
      {
        internalType: "bool",
        name: "status",
